...
class SpriteFont(object):
	...
	def draw(self, text = "Hello, Gloss!", position = (0, 0), rotation = 0.0, scale = 1.0, color = Color.WHITE, second_color = None, letterspacing = 0, linespacing = 0):
		...
		for line in lines:
			for letter in line:
				...
				glColor4f(second_color.r, second_color.g, second_color.b, second_color.a)				
